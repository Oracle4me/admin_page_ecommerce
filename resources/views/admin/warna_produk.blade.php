                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Warna Produk</h4>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                <h5 class="modal-title">Tambah Warna Produk</h5>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="nama_warna"
                                                            id="nama_warna" placeholder="Contoh: Putih" required>
                                                    </div>

                                                    <div class="col-md-6">
                                                        <label>Qty Warna</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="d-flex align-items-center gap-3" style="gap:12px;">
                                                            <input type="text" class="form-control" name="kode_warna"
                                                                id="kode_warna" placeholder="Contoh: #FFFFFF" required>

                                                            <div id="warna-preview"
                                                                style="
                                                                    width: 36px;
                                                                    height: 36px;
                                                                    border-radius: 50%;
...
@push('scripts')
    ...
    <script>
        ...
        $('#kode_warna').on('input', function() {
            ...
            // valid hex color (#RGB atau #RRGGBB)
            const isValidHex = /^#([0-9A-F]{3}){1,2}$/i.test(color);
            if (isValidHex) {
                $('#warna-preview').css('background-color', color);
            } else {
                $('#warna-preview').css('background-color', '#ffffff');
            }
        });
        ...
        $(document).ready(function() {
            var table = initDataTable('#dataTable', {
                ajax: {
                    url: "{{ route('warna.view') }}",
                    dataSrc: function(json) {
                        console.log('Data Warna:', json.data)
                        return json.data;
                    }
                },
                columns: [{
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function(row) {
                            console.log('Row Produk:', row.produk);
            ...
            $('#saveBtn').on("click", function() {
                ...
                const nama_warna = $('#nama_warna').val();
                const kode_warna = $('#kode_warna').val();
                const qty = $('#qty').val();

                let endpoint = "{{ route('warna.store') }}"
                let method = "POST";

                if (id_ukuran) {
                    endpoint = "{{ route('warna.update', ':id') }}".replace(':id', id_ukuran);
                    method = "PUT";
                }
                ajaxRequest(
                    endpoint,
            ...
            function resetForm() {
                ...
                $("#modalTitle").text("Tambah Warna Produk");
            }
            ...
            $(document).on('click', ".btn-edit", function() {
                ...
                $("#nama_warna").val(row.nama_warna);
                $("#kode_warna").val(row.kode_warna);
                $("#qty").val(row.qty);
            ...
            $('#dataTable').on('click', '.btn-delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        let url = "{{ route('warna.destroy', ':id') }}".replace(':id', rowData.id);
                        ajaxRequest(
                            url,
                            'DELETE', {}, {
                                reload: '#dataTable',
                                onSuccess: function(res) {
                                    Swal.fire('Terhapus',
                                        `Warna berhasil dihapus.`, 'success');
